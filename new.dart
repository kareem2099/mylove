...
class _FriendRequestsScreenState extends State<FriendRequestsScreen> {
  Future<void> _acceptFriendRequest(String requestId, String senderId) async {
    ...
    // Add the friend to both users' friend lists (if you have such a feature)
    // ... (Implementation for adding friends to lists) ...
  }
                    ...
                    if (userSnapshot.hasData) {
                      ...
                      return ListTile(
                        leading: CircleAvatar(
                          backgroundImage: userPhotoUrl != null ? NetworkImage(
                              userPhotoUrl) : null,
                        ),
                        title: Text(userName),
                        trailing: Row(
